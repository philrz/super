...
func (j *Join) Call(args ...vector.Any) vector.Any {
	...
	out := vector.NewStringEmpty(0, vector.NewFalse2(splitsVal.Len()))
...
func (r *Replace) Call(args ...vector.Any) vector.Any {
	...
	out := vector.NewStringEmpty(0, vector.NewFalse2(sVal.Len()))
...
func (r *RuneLen) Call(args ...vector.Any) vector.Any {
	...
	out := vector.NewIntEmpty(super.TypeInt64, val.Len(), vector.NewFalse2(val.Len()))
...
func (s *Split) Call(args ...vector.Any) vector.Any {
	...
	nulls := vector.NewFalse2(sVal.Len())
	var off uint32
	for i := uint32(0); i < sVal.Len(); i++ {
...
func (t *ToLower) Call(args ...vector.Any) vector.Any {
	...
	out := vector.NewStringEmpty(v.Len(), vector.NewFalse2(v.Len()))
...
func (t *Trim) Call(args ...vector.Any) vector.Any {
	...
	out := vector.NewStringEmpty(val.Len(), vector.NewFalse2(val.Len()))
	for i := uint32(0); i < val.Len(); i++ {
		s, null := vector.StringValue(val, i)
		if null {
			out.Nulls.Set(i)
